...
1. [Overview](#overview)
  ...
  e. [Principles](#principles)
    i. [Flat data](#flat-data)
    ii. [Future-proof](#future-proof)
    iii. [Default values](#default-values)
2. [Form Configuration Language](#form-configuration-language)
  a. [Form Fields](#form-fields)
    i. [Input specifications](#input-specifications)
    ii. [Output specifications](#output-specifications)
    iii. [Field Configs](#field-configs)
  b. [Form Configs](#form-configs)
  c. [Reserved characters](#reserved-characters)
  d. [Examples](#examples)
    i. [Python dictionaries](#python-dictionaries)
    ii. [YAML](#yaml)
    iii. [JSON](#json)
