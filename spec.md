...
Modern bureaucracies often rely on complex processes that tend to <a href="https://www.youtube.com/watch?v=JtEkUmYecnk" name="The 12 Tasks of Asterix: The Place That Sends You Mad">send you mad</a>. These processes are typically built around the idea of standardized institutional forms. An organization may have a form called `Form 29-A: request for funding`, which allows personnel to request non-travel, non-conference funding for a short-term project or work need. Once this form is completed, it then needs to be reviewed by three levels of management, acknowledged by budget personnel, and then routed back to the original submitter to include with their receipts when submitting for reimbursement. However, after a management reorganization of the budget office, the reimbursement team was disbanded and all reimbursements were handled, on a short-term basis, by the vice president for budget and operations. Even though staff were notified of this change in `circular B-65`, a number of staff are still routing their reimbursement requests to the now-unmanaged box email address for the reimbursement team, or worse sending their reimbursements directly to former personnel who they knew. These emails are either ignored, receive snide responses encouraging the sender to review `circular B-65` for the updated process, or - rarely - forward to the vice president for budget and operations for proper handling. Then, just as staff are growing accustomed to the new process for submitting reimbursements, management reinstates the reimbursement team six months later because the vice president for budget and operations no longer has the capacity to manage reimbursement requests. And even though this new process is explained thoroughly in `circular B-66`, further chaos ensues.

In more technical language, institutional form data has a tendency to require multiple users with varying institutional roles to access and modify individual records of form data in processes that vary in their formality and clarity, and which tend to change over time. The libreForms API is optimized managing and simplifying data in such environments while keeping forms flexible to change in structure and process. 
